...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div id="main-header-nav" class="collapse navbar-collapse">
        <ul id="menu-main-nav" class="nav navbar-nav main-nav underlined weight-light">
            ...
            <li class=" nav-item active">
                <a class="nav-link" href="../auth/logout.php"><i style ="color:darkgrey;"class="fa fa-"></i> Logout <span class="sr-only">(current)</span> </a>
            </li>
        </ul>
    </div>
...
<div class="container">
    ...
    <!--  <div class="container">
           <div class="row">
               ...
               <div class="col-sm">
                   <h2><span style="color:#00b6bd;">Views from Drives</span></h2>
               </div>
               <div class="col-sm">
               </div>
           </div>
       ...
       <div class="container">
           <div class="row" >
               <div class="col-sm">
                   <h6><span style="color: #00b6bd;">Irungu, Driver</span></h6>
                   <p>"Ever since i joined Shareride.Inc
